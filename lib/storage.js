...
module.exports = {
  ...
  createQuote(id, user_id, client, notes, data, created_at) {
    storage.quotes.push({ id, user_id, client, notes, data, created_at })
    saveStorage()
    return { id, user_id, client, notes, data, created_at }
  },

  updateQuote(id, client, notes, data) {
